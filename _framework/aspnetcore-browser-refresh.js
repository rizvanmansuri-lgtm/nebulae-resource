setTimeout(async function () {
  ...
  const webSocketUrls = 'wss://localhost:44332/Nebulae/,ws://localhost:53676/Nebulae/'.split(',');
  const sharedSecret = await getSecret('');
  let connection;
